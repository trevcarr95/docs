...
[Suggest Edits](/edit/on-ramp-sdk-events-properties)

# Ramps events documentation

## Interfaces

- [RampsChildToParentInterface](/docs/on-ramp-sdk-events-details#interface-rampschildtoparentinterface)
...
| Name                                       | Type                                                                   | Description                                                                 |
| ------------------------------------------ | ---------------------------------------------------------------------- | --------------------------------------------------------------------------- |
| `cryptoCurrency`                           | [`CryptoCurrency`](/docs/on-ramp-sdk-events-properties#cryptocurrency) | The crypto currency that is being off-ramped                                |
...
| `fiatCurrency`                             | [`FiatCurrency`](/docs/on-ramp-sdk-events-properties#fiatcurrency)     | The fiat currency that the customer will receive                            |
...
| Name                 | Type                                                                                                                                                                 | Description                           |
| -------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------- |
| `baseCurrency`       | [`FiatCurrency`](/docs/on-ramp-sdk-events-properties#fiatcurrency)                                                                                                   | The base (fiat) currency              |
| `baseCurrencyAmount` | `number`                                                                                                                                                             | The spent fiat amount                 |
| `id`                 | `string`                                                                                                                                                             | The identifier of the transaction     |
| `status`             | [`TransactionStatus`](/docs/on-ramp-sdk-events-properties#transactionstatus) \| [`SellTransactionStatus`](/docs/on-ramp-sdk-events-properties#selltransactionstatus) | The current status of the transaction |
...
| `quoteCurrency`       | [`CryptoCurrency`](/docs/on-ramp-sdk-events-properties#cryptocurrency)       | The quote (crypto) currency                                         |
| `quoteCurrencyAmount` | `number`                                                                     | The expected or received quote amount                               |
| `status`              | [`TransactionStatus`](/docs/on-ramp-sdk-events-properties#transactionstatus) | The current status of the transaction                               |
...
Ƭ **SellTransactionStatus**: `"completed"` | `"failed"` | `"pending"` | `"waitingForDeposit"`
